...
var g = r("image/webp");
var y = (e = {}) => {
  const { origin: t2 = "*", credentials: r2 = false, allowMethods: o2 = "*", allowHeaders: a, exposeHeaders: s, maxAge: c } = e, n = (e2) => {
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/webcrypto.js
var webcrypto_default = crypto;
var isCryptoKey = (key) => key instanceof CryptoKey;

// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/buffer_utils.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/base64url.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/util/errors.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/crypto_key.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/invalid_key_input.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/is_key_like.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/is_disjoint.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/is_object.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/check_key_length.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/jwk_to_key.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/normalize_key.js
var normalizeSecretKey = (k) => decode(k);
var privCache;
var pubCache;
var isKeyObject = (key) => {
  return key?.[Symbol.toStringTag] === "KeyObject";
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/check_key_type.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/validate_crit.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/validate_algorithms.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/subtle_dsa.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/get_sign_verify_key.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/verify.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jws/flattened/verify.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jws/compact/verify.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/epoch.js
var epoch_default = (date) => Math.floor(date.getTime() / 1e3);

// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/secs.js
var minute = 60;
var hour = minute * 60;
var day = hour * 24;
var week = day * 7;
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/lib/jwt_claims_set.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jwt/verify.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/runtime/sign.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jws/flattened/sign.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jws/compact/sign.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jwt/produce.js
...
// node_modules/.pnpm/jose@5.8.0/node_modules/jose/dist/browser/jwt/sign.js
...
// src/utils.ts
var login = async ({ query }, env) => {
  if (query.username === env.USER_NAME && query.password === env.USER_PASSWORD) {
    const second = Math.floor(parseInt(query.t) / 1e3);
    const token = await new SignJWT(query).setProtectedHeader({ alg: "HS512" }).setIssuedAt(second).setExpirationTime(second + 2 * 60 * 60).sign(new TextEncoder().encode(env.JWT_SECRET));
...
var withToken = async (request, env) => {
...
async function isValidJwt(token, secret, opt) {
  try {
...
// src/db.ts
async function queryDatabase(env, query, params = []) {
  return await env.WRBDB.prepare(query).bind(...params).all();
}
async function executeDatabase(env, query, params = []) {
...
function utf16beread(data) {
  var o2 = [];
  for (var i = 0; i < data.length >> 1; ++i) o2[i] = String.fromCharCode(data.charCodeAt(2 * i + 1) + (data.charCodeAt(2 * i) << 8));
  return o2.join("");
}
...
function a2s(data) {
  ...
  var o2 = [];
  for (var i = 0; i < data.length; ++i) o2[i] = String.fromCharCode(data[i]);
  return o2.join("");
}
function a2u(data) {
...
var bconcat = has_buf ? function(bufs) {
  ...
  if (typeof Uint8Array !== "undefined") {
    ...
    for (i = 0, maxlen = 0; i < bufs.length; maxlen += len, ++i) {
      len = bufs[i].length;
      if (bufs[i] instanceof Uint8Array) o2.set(bufs[i], maxlen);
      else if (typeof bufs[i] == "string") {
        throw "wtf";
      } else o2.set(new Uint8Array(bufs[i]), maxlen);
    }
    return o2;
  }
...
function commaify(s) {
  ...
  var j = s.length % w, o2 = s.substr(0, j);
  for (; j != s.length; j += w) o2 += (o2.length > 0 ? "," : "") + s.substr(j, w);
  return o2;
}
var pct1 = /%/g;
...
function write_num_flt(type, fmt, val) {
  ...
  if (r2 = fmt.match(frac1)) return write_num_f1(r2, aval, sign2);
  ...
  if (r2 = fmt.match(/^#{1,3},##0(\.?)$/)) return sign2 + commaify(pad0r(aval, 0));
...
function write_num_int(type, fmt, val) {
  ...
  if (r2 = fmt.match(frac1)) return write_num_f2(r2, aval, sign2);
  ...
  if (r2 = fmt.match(/^#{1,3},##0(\.?)$/)) return sign2 + commaify("" + aval);
  if (r2 = fmt.match(/^#,##0\.([#0]*0)$/)) {
...
function fmt_is_date(fmt) {
  ...
  while (i < fmt.length) {
    switch (c = fmt.charAt(i)) {
      ...
      case "[":
        o2 = c;
        while (fmt.charAt(i++) !== "]" && i < fmt.length) o2 += fmt.charAt(i);
...
function eval_fmt(fmt, v, opts, flen) {
  var out = [], o2 = "", i = 0, c = "", lst = "t", dt, j, cc;
  var hr = "H";
  while (i < fmt.length) {
    switch (c = fmt.charAt(i)) {
      case "G":
        ...
        break;
      case '"':
        for (o2 = ""; (cc = fmt.charCodeAt(++i)) !== 34 && i < fmt.length; ) o2 += String.fromCharCode(cc);
      ...
      case "g":
        ...
        o2 = c;
        while (++i < fmt.length && fmt.charAt(i).toLowerCase() === c) o2 += c;
      ...
      case ".":
        if (dt != null) {
          o2 = c;
          while (++i < fmt.length && (c = fmt.charAt(i)) === "0") o2 += c;
      ...
      case "#":
        o2 = c;
        while (++i < fmt.length && "0#?.,E+-%".indexOf(c = fmt.charAt(i)) > -1) o2 += c;
        out[out.length] = { t: "n", v: o2 };
        break;
      case "?":
        o2 = c;
        while (fmt.charAt(++i) === c) o2 += c;
        out[out.length] = { t: c, v: o2 };
        lst = c;
        break;
      case "*":
      ...
      case "9":
        o2 = c;
        while (i < fmt.length && "0123456789".indexOf(fmt.charAt(++i)) > -1) o2 += fmt.charAt(i);
...
function SSF_format(fmt, v, o2) {
  ...
  var f2 = choose_fmt(sfmt, v);
  if (SSF_isgeneral(f2[1])) return SSF_general(v, o2);
  if (v === true) v = "TRUE";
  else if (v === false) v = "FALSE";
  else if (v === "" || v == null) return "";
  return eval_fmt(f2[1], v, o2, f2[0]);
}
...
var CFB = /* @__PURE__ */ function _CFB() {
  ...
  function _write(cfb, options) {
    ...
    var i2 = 0, T = 0;
    {
      for (i2 = 0; i2 < 8; ++i2) o2.write_shift(1, HEADER_SIG[i2]);
      for (i2 = 0; i2 < 8; ++i2) o2.write_shift(2, 0);
      o2.write_shift(2, 62);
      o2.write_shift(2, 3);
      o2.write_shift(2, 65534);
      o2.write_shift(2, 9);
      o2.write_shift(2, 6);
      for (i2 = 0; i2 < 3; ++i2) o2.write_shift(2, 0);
      o2.write_shift(4, 0);
      ...
      for (i2 = 0; i2 < 109; ++i2) o2.write_shift(-4, i2 < L[2] ? L[1] + i2 : -1);
    }
    if (L[1]) {
      for (T = 0; T < L[1]; ++T) {
        for (; i2 < 236 + T * 127; ++i2) o2.write_shift(-4, i2 < L[2] ? L[1] + i2 : -1);
        o2.write_shift(-4, T === L[1] - 1 ? ENDOFCHAIN : T + 1);
      }
    }
    var chainit = function(w) {
      for (T += w; i2 < T - 1; ++i2) o2.write_shift(-4, i2 + 1);
      if (w) {
        ++i2;
    ...
    T = i2 = 0;
    for (T += L[1]; i2 < T; ++i2) o2.write_shift(-4, consts.DIFSECT);
    for (T += L[2]; i2 < T; ++i2) o2.write_shift(-4, consts.FATSECT);
    chainit(L[3]);
    chainit(L[4]);
    var j = 0, flen = 0;
  ...
  function a2s2(o2) {
    ...
    for (var i2 = 0; i2 < o2.length; ++i2) out[i2] = String.fromCharCode(o2[i2]);
    return out.join("");
  }
  ...
  function read_bits_n(buf, bl, n) {
    var w = bl & 7, h2 = bl >>> 3, f2 = (1 << n) - 1;
    var v = buf[h2] >>> w;
    if (n < 8 - w) return v & f2;
    v |= buf[h2 + 1] << 8 - w;
    if (n < 16 - w) return v & f2;
    v |= buf[h2 + 2] << 16 - w;
    if (n < 24 - w) return v & f2;
    v |= buf[h2 + 3] << 24 - w;
    return v & f2;
  }
  ...
  function realloc(b, sz) {
    ...
    if (has_buf) {
      ...
      if (b.copy) b.copy(o2);
      else for (; i2 < b.length; ++i2) o2[i2] = b[i2];
      return o2;
  ...
  function write_base64_76(bstr) {
    ...
    var o2 = [];
    for (var i2 = 0; i2 < data.length; i2 += 76) o2.push(data.slice(i2, i2 + 76));
    return o2.join("\r\n") + "\r\n";
  }
...
function keys(o2) {
  ...
  for (var i = 0; i < ks.length; ++i) if (Object.prototype.hasOwnProperty.call(o2, ks[i])) o22.push(ks[i]);
  return o22;
}
function evert_key(obj, key) {
  var o2 = [], K = keys(obj);
  for (var i = 0; i !== K.length; ++i) if (o2[obj[K[i]][key]] == null) o2[obj[K[i]][key]] = K[i];
  return o2;
}
function evert(obj) {
  var o2 = [], K = keys(obj);
  for (var i = 0; i !== K.length; ++i) o2[obj[K[i]]] = K[i];
  return o2;
}
function evert_num(obj) {
  var o2 = [], K = keys(obj);
  for (var i = 0; i !== K.length; ++i) o2[obj[K[i]]] = parseInt(K[i], 10);
  return o2;
}
function evert_arr(obj) {
  var o2 = [], K = keys(obj);
  for (var i = 0; i !== K.length; ++i) {
    if (o2[obj[K[i]]] == null) o2[obj[K[i]]] = [];
    o2[obj[K[i]]].push(K[i]);
  }
  return o2;
}
...
function cc2str(arr, debomit) {
  ...
  var o2 = [];
  for (var i = 0; i != arr.length; ++i) o2.push(String.fromCharCode(arr[i]));
  return o2.join("");
}
function dup(o2) {
...
function fuzzydate(s) {
  var o2 = new Date(s), n = /* @__PURE__ */ new Date(NaN);
  var y2 = o2.getYear(), m = o2.getMonth(), d = o2.getDate();
  if (isNaN(d)) return n;
...
function utf8reada(orig) {
  var out = "", i = 0, c = 0, d = 0, e = 0, f2 = 0, w = 0;
  while (i < orig.length) {
    c = orig.charCodeAt(i++);
    if (c < 128) {
    ...
    w = ((c & 7) << 18 | (d & 63) << 12 | (e & 63) << 6 | f2 & 63) - 65536;
...
var htmldecode = /* @__PURE__ */ function() {
  ...
  return function htmldecode2(str) {
    ...
    for (var i = 0; i < entities.length; ++i) o2 = o2.replace(entities[i][0], entities[i][1]);
    return o2;
  };
}();
var wtregex = /(^\s|\s$|\n)/;
...
function write_vt(s, xlsx) {
  switch (typeof s) {
    case "string":
      var o2 = writextag("vt:lpwstr", escapexml(s));
      if (xlsx) o2 = o2.replace(/&quot;/g, "_x0022_");
      return o2;
    case "number":
...
function ReadShift(size, t2) {
  ...
  switch (t2) {
    ...
    case "utf16le":
      ...
      break;
    case "wstr":
      if (typeof $cptable !== "undefined") o2 = $cptable.utils.decode(current_codepage, this.slice(this.l, this.l + 2 * size));
...
function write_manifest(manifest) {
  ...
  for (var i = 0; i < manifest.length; ++i) o2.push('  <manifest:file-entry manifest:full-path="' + manifest[i][0] + '" manifest:media-type="' + manifest[i][1] + '"/>\n');
...
function write_core_props(cp, _opts) {
  ...
  for (var i = 0; i != CORE_PROPS.length; ++i) {
    var f2 = CORE_PROPS[i];
    var v = opts.Props && opts.Props[f2[1]] != null ? opts.Props[f2[1]] : cp ? cp[f2[1]] : null;
    if (v === true) v = "1";
    else if (v === false) v = "0";
    else if (typeof v == "number") v = String(v);
    if (v != null) cp_doit(f2[0], v, null, o2, p2);
  }
  if (o2.length > 2) {
...
function write_ext_props(cp) {
  ...
  EXT_PROPS.forEach(function(f2) {
    ...
    switch (f2[2]) {
      case "string":
        v = escapexml(String(cp[f2[1]]));
        break;
      case "bool":
        v = cp[f2[1]] ? "true" : "false";
        break;
    }
    if (v !== void 0) o2[o2.length] = W(f2[0], v);
  });
  ...
  o2[o2.length] = W("TitlesOfParts", W("vt:vector", cp.SheetNames.map(function(s) {
...
function xlml_write_docprops(Props, opts) {
  ...
  keys(XLMLDocPropsMap).map(function(m) {
    ...
    o2.push(writetag(XLMLDocPropsMap[p2[1]] || p2[1], m));
  });
...
function writezeroes(n, o2) {
  if (!o2) o2 = new_buf(n);
  for (var j = 0; j < n; ++j) o2.write_shift(1, 0);
  return o2;
}
...
function write_HyperlinkString(str, o2) {
  ...
  for (var i = 0; i < str.length; ++i) o2.write_shift(2, str.charCodeAt(i));
  o2.write_shift(2, 0);
  return o2;
}
...
function write_MergeCells(merges) {
  ...
  for (var i = 0; i < merges.length; ++i) write_Ref8U(merges[i], o2);
  return o2;
}
  ...
  function sheet_to_sylk(ws, opts) {
    ...
    for (var R = r2.s.r; R <= r2.e.r; ++R) {
      for (var C = r2.s.c; C <= r2.e.c; ++C) {
        ...
        o2.push(write_ws_cell_sylk(cell, ws, R, C, opts));
      }
    }
...
var DIF = /* @__PURE__ */ function() {
  ...
  var sheet_to_dif = /* @__PURE__ */ function() {
    var push_field = function pf(o2, topic, v, n, s) {
      o2.push(topic);
      o2.push(v + "," + n);
      o2.push('"' + s.replace(/"/g, '""') + '"');
    };
    var push_value = function po(o2, type, v, s) {
      o2.push(type + "," + v);
      o2.push(type == 1 ? '"' + s.replace(/"/g, '""') + '"' : s);
    };
        ...
        for (var C = r2.s.c; C <= r2.e.c; ++C) {
          ...
          switch (cell.t) {
            case "n":
              ...
              if (val == null) {
                if (DIF_XL && cell.f && !cell.F) push_value(o2, 1, 0, "=" + cell.f);
            ...
            case "d":
              ...
              if (DIF_XL) push_value(o2, 0, cell.w, "V");
              else push_value(o2, 1, 0, cell.w);
              break;
            default:
              push_value(o2, 1, 0, "");
          }
...
var PRN = /* @__PURE__ */ function() {
  ...
  function dsv_to_sheet_str(str, opts) {
    var o2 = opts || {};
    var sep = "";
    if (DENSE != null && o2.dense == null) o2.dense = DENSE;
    var ws = o2.dense ? [] : {};
    ...
    function finish_cell() {
      ...
      if (s.length === 0) cell.t = "z";
        ...
        cell.t = "n";
        if (o2.cellText !== false) cell.w = s;
        cell.v = v;
      } else if (!isNaN(fuzzydate(s).getDate()) || _re && s.match(_re)) {
        cell.z = o2.dateNF || table_fmt[14];
        var k = 0;
        if (_re && s.match(_re)) {
          s = dateNF_fix(s, o2.dateNF, s.match(_re) || []);
          k = 1;
        }
        if (o2.cellDates) {
          cell.t = "d";
...
var WK_ = /* @__PURE__ */ function() {
  ...
  function lotus_to_workbook_buf(d, opts) {
    ...
    var o2 = opts || {};
    if (DENSE != null && o2.dense == null) o2.dense = DENSE;
    var s = o2.dense ? [] : {}, n = "Sheet1", next_n = "", sidx = 0;
      ...
      lotushopper(d, function(val, R, RT) {
        switch (RT) {
          ...
          case 16:
            ...
            var tmpcell = o2.dense ? (s[val[0].r] || [])[val[0].c] : s[encode_cell(val[0])];
            if (tmpcell) {
              tmpcell.t = val[1].t;
              tmpcell.v = val[1].v;
  ...
  function parse_NUMBER_17(blob, length) {
    ...
    var s = e & 32768;
    e = (e & 32767) - 16446;
    o2[1].v = (1 - s * 2) * (v2 * Math.pow(2, e + 32) + v1 * Math.pow(2, e));
    return o2;
  }
...
function _JS2ANSI(str) {
  ...
  var o2 = [], oo = str.split("");
  for (var i = 0; i < oo.length; ++i) o2[i] = oo[i].charCodeAt(0);
  return o2;
}
...
function rgb2Hex(rgb) {
  for (var i = 0, o2 = 1; i != 3; ++i) o2 = o2 * 256 + (rgb[i] > 255 ? 255 : rgb[i] < 0 ? 0 : rgb[i]);
...
function write_numFmts(NF) {
  ...
  [[5, 8], [23, 26], [41, 44], [
    ...
    for (var i = r2[0]; i <= r2[1]; ++i) if (NF[i] != null) o2[o2.length] = writextag("numFmt", null, { numFmtId: i, formatCode: escapexml(NF[i]) });
  });
...
function parse_PtgAttrChoose(blob, length, opts) {
  ...
  var o2 = [];
  for (var i = 0; i <= offset; ++i) o2.push(blob.read_shift(opts && opts.biff == 2 ? 1 : 2));
  return o2;
}
...
function parse_PtgExtraArray(blob, length, opts) {
  ...
  for (var i = 0, o2 = []; i != rows && (o2[i] = []); ++i)
    for (var j = 0; j != cols; ++j) o2[i][j] = parse_SerAr(blob, opts.biff);
  return o2;
}
...
function write_ws_xml_merges(merges) {
  ...
  for (var i = 0; i != merges.length; ++i) o2 += '<mergeCell ref="' + encode_range(merges[i]) + '"/>';
...
function write_ws_xml_data(ws, opts, idx, wb) {
  ...
  for (R = range.s.r; R <= range.e.r; ++R) {
    ...
    for (C = range.s.c; C <= range.e.c; ++C) {
      ...
      if ((cell = write_ws_xml_cell(_cell, ref, ws, opts, idx, wb)) != null) r2.push(cell);
    }
...
function write_BrtWsProp(str, outl, o2) {
  ...
  o2.write_shift(1, f2);
  for (var i = 1; i < 3; ++i) o2.write_shift(1, 0);
  write_BrtColor({ auto: 1 }, o2);
  o2.write_shift(-4, -1);
  o2.write_shift(-4, -1);
...
function write_wb_xml(wb) {
  ...
  if (write_names) {
    ...
    if (wb.Workbook && wb.Workbook.Names) wb.Workbook.Names.forEach(function(n) {
      ...
      if (!n.Ref) return;
      o2[o2.length] = writextag("definedName", escapexml(n.Ref), d);
    });
    o2[o2.length] = "</definedNames>";
  }
  if (o2.length > 2) {
...
function write_BrtFileVersion(data, o2) {
  if (!o2) o2 = new_buf(127);
  for (var i = 0; i != 4; ++i) o2.write_shift(4, 0);
...
function write_props_xlml(wb, opts) {
  ...
  if (wb.Custprops) o2.push(xlml_write_custprops(wb.Props, wb.Custprops, opts));
  return o2.join("");
}
...
function write_biff2_buf(wb, opts) {
  ...
  var ba = buf_array();
  var idx = 0;
  for (var i = 0; i < wb.SheetNames.length; ++i) if (wb.SheetNames[i] == o2.sheet) idx = i;
...
function write_biff8_buf(wb, opts) {
  ...
  for (var i = 0; i < wb.SheetNames.length; ++i) bufs[bufs.length] = write_ws_biff8(i, o2, wb);
...
var write_content_ods = /* @__PURE__ */ function() {
  ...
  return function wcx(wb, opts) {
    ...
    for (var i = 0; i != wb.SheetNames.length; ++i) o2.push(write_ws2(wb.Sheets[wb.SheetNames[i]], wb, i, opts));
    o2.push("    </office:spreadsheet>\n");
    o2.push("  </office:body>\n");
...
function make_csv_row(sheet, r2, R, cols, fs, rs, FS, o2) {
  ...
  for (var C = r2.s.c; C <= r2.e.c; ++C) {
    ...
    if (val == null) txt = "";
      ...
      for (var i = 0, cc = 0; i !== txt.length; ++i) if ((cc = txt.charCodeAt(i)) === fs || cc === rs || cc === 34 || o2.forceQuotes) {
...
function sheet_to_txt(sheet, opts) {
  ...
  var o2 = $cptable.utils.encode(1200, s, "str");
...
function sheet_set_array_formula(ws, range, formula, dynamic) {
  ...
  for (var R = rng2.s.r; R <= rng2.e.r; ++R) for (var C = rng2.s.c; C <= rng2.e.c; ++C) {
...
// src/handlers.ts
async function listColors({ query }, env) {
...
async function addColor(request, env) {
  const data = await request.json();
  await executeDatabase(env, "INSERT INTO home_colortable (color, desc, status, create_time) VALUES (?, ?, ?, ?)", [data.color, data.desc, data.status || 0, data.create_time || (/* @__PURE__ */ new Date()).toISOString()]);
  return new Response(JSON.stringify({ code: 0, msg: "success" }), { headers: { "Content-Type": "application/json" } });
}
async function setColor(request, env) {
  const data = await request.json();
...
async function updateColor(request, env) {
  const data = await request.json();
...
async function deleteColor(request, env) {
...
async function listKeyword(request, env) {
...
async function addKeyword(request, env) {
  const data = await request.json();
  ...
  if (existing.results.length > 0) {
    ...
    await executeDatabase(env, "INSERT INTO home_keywordtable (keyword, keyword_heavy, keyword_html, definition, industry_definition, anagram, create_time) VALUES (?, ?, ?, ?, ?, ?, ?)", [
      ...
      data.keyword_html,
      data.definition,
      data.industry_definition,
      data.anagram,
      data.create_time || (/* @__PURE__ */ new Date()).toISOString()
    ]);
...
async function updateGroupId(request, env) {
  const data = await request.json();
...
async function updateRemark(request, env) {
  const data = await request.json();
  await executeDatabase(env, "UPDATE home_keywordtable SET remark = ? WHERE id = ?", [data.remark, data.id]);
  return new Response(JSON.stringify({ code: 0, msg: "success" }), { headers: { "Content-Type": "application/json" } });
}
async function getKeywordById(request, env) {
  const keywords = await queryDatabase(env, "SELECT hk.*, hc.name FROM home_keywordtable hk left join home_categorytable hc on hk.group_id = hc.uuid where hk.id = ?", [parseInt(request.query.id)]);
  return new Response(JSON.stringify({
    code: 0,
    result: keywords.results
  }), { headers: { "Content-Type": "application/json" } });
}
async function listCategory(request, env) {
...
async function addCategory(request, env) {
  const data = await request.json();
  if (!data.id) {
    await executeDatabase(env, "INSERT INTO home_categorytable (uuid, name, create_time) VALUES (?, ?, ?)", [v4_default().replace(/-/g, ""), data.name, data.create_time || (/* @__PURE__ */ new Date()).toISOString()]);
  } else {
    await executeDatabase(env, "UPDATE home_categorytable set uuid = ?, name = ?, create_time = ? where id = ?", [data.uuid, data.name, data.create_time || (/* @__PURE__ */ new Date()).toISOString(), data.id]);
  }
  return new Response(JSON.stringify({ code: 0, msg: "success" }), { headers: { "Content-Type": "application/json" } });
}
...
async function download(request, env) {
  ...
  const file_name = Math.floor(Date.now() / 1e3);
  const params = [];
  if (!!data) {
    ...
    const excelData = [
      ["\u5355\u8BCD", "\u91CD\u97F3", "\u91CA\u4E49", "\u5907\u6CE8", "\u5206\u7C7B", "\u521B\u5EFA\u65F6\u95F4"],
      // 表头
      ...keywords.results.map((item) => [item.keyword, item.keyword_heavy, item.definition.replace("_", "\r\n"), item.remark, item.name, new Date(item.create_time).toISOString().slice(0, 19).replace("T", " ")])
    ];
    const ws = utils.aoa_to_sheet(excelData);
    const wb = utils.book_new();
    utils.book_append_sheet(wb, ws, "Sheet1");
    const xlsxBinary = writeSync(wb, { bookType: "xlsx", type: "array" });
    const bucket = env.WRBB;
  ...
  return new Response(JSON.stringify({ code: 0, msg: "\u64CD\u4F5C\u6210\u529F", file_name }), { headers: { "Content-Type": "application/json" } });
}
async function doDownload({ query }, env) {
  ...
  responseHeaders.set("Content-Disposition", `attachment; filename="${query.file_name}.xlsx"`);
...
var { preflight, corsify } = y({
  ...
  // 必须指定具体的 origin
  credentials: true,
  // 允许发送凭证（如 Cookies、Authorization headers）
...
var router = t({
  ...
  // and corsify downstream
});
router.get("/manage/login", login).post("/manage/download", withToken, download).get("/manage/download", doDownload).get("/manage/color/list", listColors).post("/manage/color/add", withToken, addColor).put("/manage/color/setColor", withToken, setColor).put("/manage/color/update", withToken, updateColor).delete("/manage/color/:id", withToken, deleteColor).get("/manage/keyword/list", withToken, listKeyword).post("/manage/keyword/add", addKeyword).put("/manage/keyword/put", withToken, updateGroupId).delete("/manage/keyword/delete", deleteKeywords).delete("/manage/keyword/:id", withToken, deleteKeyword).put("/manage/keyword/remark", withToken, updateRemark).get("/manage/keyword/byId", withToken, getKeywordById).get("/manage/category/list", withToken, listCategory).post("/manage/category/add", withToken, addCategory).delete("/manage/category/:id", withToken, deleteCategory);
